...
public class DELETE_LANE{
	...
	public void run_DELETE_LANE( Integer Lane){
		if(guard_DELETE_LANE(Lane)) {
			...
			machine.set_friction(friction_tmp.domainSubtraction(new BSet<Integer>(Lane)));
